...
// angular.module('gnaviApp.services', [])
//   .factory('gnaviAPIservice', function($http) {
...
//     gnaviAPI.getRest = function(areaCode) {
//       return $http({
//         method: 'JSONP', 
//         url: 'http://api.gnavi.co.jp/ver1/RestSearchAPI/?keyid=23cf42cc2b30d584faae96e40544372e&area=' + areaCode + '&hit_per_page=1&format=json&callback=JSON_CALLBACK'
//       });
//     }
